...
M_pipeline = M_viewport * M_projection * M_view * M_model

%for i = 1 : 8
%    v_wrong_screen(i).c = M_pipeline * v_obj(i).c;
%endfor
v_wrong_screen = M_pipeline * v_obj;
...
%for i = 1 : 8
%    v_screen(i).c = v_wrong_screen(i).c / v_wrong_screen(i).c(4);
%endfor
v_screen = v_wrong_screen ./ v_wrong_screen(4, :);
